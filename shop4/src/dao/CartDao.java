...
public interface CartDao {
	...
	// 更新购物车(+/-)
	public void updateCart2(Integer amount, double price, Integer cart_id,double price_cart);
	...
	// 查询cart_id是否已经存在
	public Integer searchCart_idExit(Integer cart_id);

	// 查询购物车里商品是否已经存在
	public Integer searchPro_idExit(Integer pro_id, Integer cart_id);
}
