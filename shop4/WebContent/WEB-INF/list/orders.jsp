...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".delete").click(function() {
			var orderId = $(this).parents("div").data("id");
			location.href="deleteOrder.do?orderId="+orderId;
// 			$.ajax({
// 				url:"deleteOrder.do",
// 				type:"post",
...
// 			})
		...
		$(".member-touch").click(function() {
			var orderId = $(this).parents("div").data("id");
			var orderNum = $(this).parents("div").data("ordernum");
			var price = $(this).parents("div").data("price");
			location.href="showPay.do?orderId="+orderId+"&orderNum="+orderNum+"&price="+price;
		})
		...
		<div class="member-right fr">
			...
			<div class="member-whole clearfix">
				<ul id="H-table" class="H-table">
					<li class="order cur"><a href="#">未付款</a></li>
					<li class="dfk"><a href="#">已付款</a></li>
					<li><a href="#">待发货</a></li>
					<li><a href="#">待收货</a></li>
					<li><a href="#">交易完成</a></li>
					<li><a href="#">订单信息</a></li>
			...
			<div class="member-border">
				...
				<div class="member-return H-over" >
					...
					<div class="member-sheet clearfix orderItem">
						<ul>
							...
							<li>
								<div class="member-minute clearfix">
									...
									<span>订单号：<em>${order.order_num}</em></span>
									<span><a href="#"></a></span>
									<span class="member-custom">客服电话：<em>010-6544-0986</em></span>
								</div>
								<div class="member-circle clearfix">
									<div class="ci1">
									<c:forEach items="${order.listOrderItem}" var="oi">
										<div class="ci7 clearfix" data-id="${oi.product.id}">
											<span class="gr1"><a href="#"><img src="${oi.product.imgs[0].path }" title="${oi.product.title }" about="" width="60" height="60"></a></span>
											<span class="gr2"><a href="#">${oi.product.name}</a></span>
											<span class="gr3">X${oi.amount}</span>
										</div>
									</c:forEach>
									</div>
									<div class="ci2">admin</div>
									<div class="ci3"><b>${order.total_price}</b><p class="iphone">手机订单</p></div>
									<div class="ci4"><p>${order.create_time}</p></div>
									<div class="ci5"><p>等待付款</p></div>
									<div class="ci5 ci8" data-id="${order.id}" data-ordernum="${order.order_num}" data-price="${order.total_price}"><p>剩余7时40分</p> <p><a href="#" class="member-touch">立即支付</a> </p> <p class="delete"><a href="#">取消订单</a> </p></div>
								</div>
							</li>
							</c:forEach>
						</ul>
				...
				<div class="member-return H-over dfkItem mydiv">

					<div class="member-sheet clearfix">
						<ul>

							<c:forEach items="${listOrderIsPay}" var="order">
							<li>
								<div class="member-minute clearfix">
									<span>${order.create_time}</span>
									<span>订单号：<em>${order.order_num}</em></span>
								...
								<div class="member-circle clearfix">
									...
									<div class="ci2">阿鹏</div>
									<div class="ci3"><b>${order.total_price}</b><p class="iphone">手机订单</p></div>
									<div class="ci4"><p>${order.create_time}</p></div>
									<div class="ci5"><p><a href="#">已付款</a></p></div>
									<div class="ci6" data-id="${order.id}"><p><a href="#">订单详情</a> </p></div>
								</div>
							</li>
							</c:forEach>
						</ul>
...
$(".pc-head-car").click(function(){
   ...
   $(".clearfix .H-table li").click(function(){
	   $(this).addClass("cur").siblings().removeClass("cur");
	  // $(this).addClass("show").siblings().removeClass("show");
   })
   
    $(".dfk").click(function(){
	  $(".dfkItem").removeClass("mydiv");
	  $(".orderItem").addClass("mydiv");
   })
   $(".order").click(function(){
	  $(".dfkItem").addClass("mydiv");
	  $(".orderItem").removeClass("mydiv");
   })
</script>
</body>
</html>