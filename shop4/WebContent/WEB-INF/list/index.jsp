...
<header id="pc-header">
	...
	<div class="pc-header-logo clearfix">
		...
		<div class="head-form fl">
			<form class="clearfix">
				<input class="search-text" accesskey="" id="key" autocomplete="off" placeholder="篮球鞋" type="text">
				<div id="search-btn"><input type="button" value="搜索" class="button" /></div>
			</form>
	...
	<div class="yHeader">
		...
		<div class="yNavIndex">
			...
			<ul class="yMenuIndex">
				...
				<li><a href="" target="_blank">京东物 </a></li>
