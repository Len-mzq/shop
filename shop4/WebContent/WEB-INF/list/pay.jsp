...
<meta name="Generator" content="EditPlus®">
	...
	$().ready(function(){
		...
		$(".tr_checkmr").trigger("click",function(){
			var product_id = "";
			var amount = 0;
			var price = 0;
			var count = 0;
		...
		location.href="doPay.do?orderNum="+"${orderNum}"; 
		})
			...
			<table>
				...
				<tbody>
					...
					<c:forEach items="${pro}" var="pro" varStatus="i">
						<tr data-id="${pro.id}">
							<th><input type="checkbox" checked="checked" class="choose" name="selectId" style="margin-left:10px; float:left"></th>
							<th class="tab-th-1">
	...
	<div class="center">
		<div class="clearfix pc-shop-go">
			...
			<div class="fr pc-shop-fr">
				<p>总计（不含运费）</p>
				<span class="red pc-shop-price">${price } </span>
				<a id="toPay">立即支付</a>
			</div>
		</div>
	</div>
